"""Adopted from https://github.com/uzh-rpg/RVT/blob/master/utils/timers.py"""
...
class CudaTimer:
    """
    Usage:
        with CudaTimer(device=device, timer_name="xxx"):
            func()
    """
...
# print all the times upon termination of any program that imported this file
